...
// ImagePullSpec defines the desired state of ImagePull
type ImagePullSpec struct {
	// INSERT ADDITIONAL SPEC FIELDS - desired state of cluster
	// Important: Run "make" to regenerate code after modifying this file
}

// ImagePullStatus defines the observed state of ImagePull
...
// ImagePull is the Schema for the imagepulls API
